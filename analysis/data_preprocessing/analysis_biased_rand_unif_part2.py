...
if __name__=="__main__":
    os.chdir(os.path.abspath(os.path.dirname(__file__)))
    print(os.getcwd())
    df= pd.read_csv("biased_rand_unif.csv")
    #print(df.shape)
    ...
    ax[0,0].set_xlabel("Probability of edge existance p ")
    ...
    ax[0,1].set_xlabel("Probability of edge existance p ")
    ...
    ax[0,2].set_xlabel("Probability of edge existance p ")
    ax[0,2].set_title("Probability of non polarisation")
    #plt.savefig("avg_time_to_stab_avg_dist_normal.png")
    #plt.show()
    ...
    ax[1,0].set_xlabel("Probability of edge existance p")
